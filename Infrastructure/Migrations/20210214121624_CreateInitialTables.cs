        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ExpectedWithdrawalDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedWithdrawalDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RealWithdrawalDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpectedReturnDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RealReturnDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HourlyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Subtotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ExtraCosts = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Quotations_QuotationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TankFull = table.Column<bool>(type: "bit", nullable: false),
                    Dents = table.Column<bool>(type: "bit", nullable: false),
                    Scratches = table.Column<bool>(type: "bit", nullable: false),
                    MissingLiters = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checklists_Schedules_Id",
                        column: x => x.Id,
