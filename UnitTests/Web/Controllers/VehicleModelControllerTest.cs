...
namespace UnitTests.Web.Controllers
{
    ...
    {
        private VehicleModelController _controller { get; set; }
        private Mock<IBaseService<VehicleModel>> _service { get; set; }
        ...
        public async void TestGetAll()
        {
            _service.Setup(s => s.GetAllAsync()).Returns(
                Task.FromResult(Enumerable.Empty<VehicleModel>())
            );
            ...
            Assert.Equal(Enumerable.Empty<VehicleModel>(), response.Value);
        }
        ...
        public async void TestGetAllWithName()
        {
            ...
            )).Returns(Task.FromResult(Enumerable.Empty<VehicleModel>()));
        ...
        public async void TestFind()
        {
            ...
            var modelMock = new VehicleModel() { Id = guid };
