...
namespace UnitTests.Web.Controllers
{
    ...
    {
        private VehicleBrandController _controller { get; set; }
        private Mock<IBaseService<VehicleBrand>> _service { get; set; }

        public VehicleBrandControllerTest()
        {
            var logger = new Mock<ILogger<VehicleBrand>>();
            _service = new Mock<IBaseService<VehicleBrand>>();
            _controller = new VehicleBrandController(logger.Object, _service.Object);
        }
        ...
        public async void TestFind()
        {
            ...
            var modelMock = new VehicleBrand() { Id = guid };
